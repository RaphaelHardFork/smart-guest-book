...
contract SmartGuestBook is ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    event CommentLeaved(address indexed author, bytes32 indexed hashedComment, uint256 tokenId);
    ...
    function comment(bytes32 hashedComment, string memory uri) public returns (uint256) {
        ...
        _comments[newCommentId] = Comment(msg.sender, hashedComment, newCommentId, uri);
        emit CommentLeaved(msg.sender, hashedComment, newCommentId);
